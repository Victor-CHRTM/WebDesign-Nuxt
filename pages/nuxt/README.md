...
![Import du site via Nuxt & Supabase & Vercel](../../assets/images/nuxt/Etape1-Nuxt.png)
...
![Constatation des changements sur le site live (Vercel)](../../assets/images/nuxt/Etape2-Nuxt.png)
...
![Ajout d'une nouvelle images avec un problème de positionnement](../../assets/images/nuxt/Etape3-Nuxt.png)
...
![Avant l'ajout de l'image d'un chien - les positions sont toutes différentes](../../assets/images/nuxt/Etape4.1-Nuxt.png)

> Je créé un nouvel élément avec la photo d'un chien et la position à '1'

![Après l'ajout de l'image d'un chien - les positions sont bien modifiées](../../assets/images/nuxt/Etape4.2-Nuxt.png)
...
![Avant la modification de la position de l'image du chien](../../assets/images/nuxt/Etape5.1-Nuxt.png)

> Je modifie la position du chien et je le met à la position 3

![Après la modification de la position de l'image du chien](../../assets/images/nuxt/Etape5.2-Nuxt.png)
